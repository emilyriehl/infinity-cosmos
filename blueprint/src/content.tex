...
\begin{definition}[the simplex category]\label{defn:simplex-category}
 \lean{InfinityCosmos.Mathlib.SimplexCategory.smallCategory}
 \leanok
...
\begin{definition}[elementary face maps]\label{defn:face-map}
  \lean{InfinityCosmos.Mathlib.SimplexCategory.δ}
  \leanok
...
\begin{definition}[elementary degeneracy maps]\label{defn:degeneracy-map}
  \lean{InfinityCosmos.Mathlib.SimplexCategory.σ}
  \leanok
  \uses{defn:simplex-category}
...
\begin{defn}[simplicial set]\label{defn:simplicial-set}
  \lean{InfinityCosmos.Mathlib.SSet}
  \leanok
  \uses{defn:simplex-category}
...
\begin{definition}[the category of simplicial sets]\label{defn:sset-category}
  \lean{InfinityCosmos.Mathlib.SSet.largeCategory}
\leanok
...
\begin{definition}[standard simplex]\label{defn:standard-simplex}
  \lean{InfinityCosmos.Mathlib.SSet.standardSimplex}
  \leanok
...
\begin{definition}[simplex boundary]\label{defn:simplex-boundary}
  \lean{InfinityCosmos.Mathlib.SSet.boundary}
  \leanok
...
\begin{definition}[simplicial horn]\label{defn:simplicial-horn}
  \lean{InfinityCosmos.Mathlib.SSet.horn}
  \leanok
  \uses{defn:standard-simplex}
...
\begin{lemma}\label{lem:simplex-yoneda}
  \lean{InfinityCosmos.Mathlib.SSet.yonedaEquiv}
  \leanok
  \uses{defn:standard-simplex}
...
\lean{InfinityCosmos.Mathlib.SSet.hasLimits}
\leanok
...
\begin{corollary}\label{cor:sset-cat-colimits}
  \lean{InfinityCosmos.Mathlib.SSet.hasColimits}
  \leanok
  \uses{defn:sset-category}
...
\lean{InfinityCosmos.Mathlib.SSet.Quasicategory}
\leanok
\uses{defn:simplicial-set}
...
\end{definition}
  ...
  \begin{definition}[Kan complex]\label{defn:kan-complex}
    \lean{InfinityCosmos.Mathlib.SSet.KanComplex}
    \leanok
    \uses{defn:simplicial-set}
...
\begin{definition}[nerve]\label{defn:nerve}
  \lean{InfinityCosmos.Mathlib.CategoryTheory.nerve}
  \leanok
  \uses{defn:simplicial-set}
...
\begin{definition}[nerve functor]\label{defn:nerve-functor}
  \lean{InfinityCosmos.Mathlib.CategoryTheory.nerveFunctor}
  \leanok
  \uses{defn:nerve}
...
\lean{InfinityCosmos.Mathlib.CategoryTheory.SimplicialCategory}
\leanok
\uses{defn:sset-category}
...
\begin{definition}\label{defn:lax-monoidal-functor}
  \lean{InfinityCosmos.Mathlib.CategoryTheory.LaxMonoidalFunctor}
  \leanok
