...
\begin{definition}[isofibration]\label{defn:qcat-isofibration}
  ...
  \leanok
  A simplicial map $f \colon A \to B$, where $B$ is a quasi-category, is an \textbf{isofibration} if it lifts against the inner horn inclusions, as displayed below-left, and also against the inclusion of either vertex into the free-living isomorphism $\iso$.
  \begin{center}
  \begin{tikzcd}
