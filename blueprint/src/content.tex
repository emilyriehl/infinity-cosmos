...
\begin{ntn}[the simplex category]\label{ntn:simplex-cat} Let $\Del$ denote the \textbf{simplex category} of finite nonempty ordinals $[n] = \{0 <1 <\cdots < n\}$ and order-preserving maps. These include in particular the
\[
