...
\begin{proposition}\label{prop:change-of-base}
  ...
  A finite-product-preserving functor $T \colon \cV \to \cW$ between cartesian closed categories induces a change-of-base 2-functor \[ \begin{tikzcd} \eCat{\cV} \arrow[r, "T_*"] & \eCat{\cW}\, . \end{tikzcd}\]
\end{proposition}
